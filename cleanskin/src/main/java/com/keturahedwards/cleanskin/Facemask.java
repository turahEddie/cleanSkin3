...
public class Facemask extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    Animation zoom_in;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Facemask.this, DashBoard.class));
            }
        });
    ...
    public void createCalenderPopIp() {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.mask, android.R.layout.simple_spinner_dropdown_item);

...
public class Eyeliner extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    Animation zoom_in;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Eyeliner.this, DashBoard.class));
            }
        });
    ...
    public void createCalenderPopIp() {
        ...
        icon.setImageResource((R.drawable.eyeliner));

        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.eyeliner, android.R.layout.simple_spinner_dropdown_item);
        ...
        save.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(CalendarContract.Events.TITLE, "Eyeliner update for " + newBrandName.getText().toString());

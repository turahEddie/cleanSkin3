...
public class Eyeshadow extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    Animation zoom_in;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Eyeshadow.this, DashBoard.class));
            }
        });
    }

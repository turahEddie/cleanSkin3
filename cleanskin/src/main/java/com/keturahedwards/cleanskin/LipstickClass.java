...
public class LipstickClass extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    Animation zoom_in;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lipstick_class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LipstickClass.this, DashBoard.class));
            }
        });
    ...
    public void createCalenderPopIp() {
        ...
        icon.setImageResource((R.drawable.mattelip));

        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.lipstick, android.R.layout.simple_spinner_dropdown_item);
        ...
        save.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(CalendarContract.Events.TITLE, "Lipstick update for " + newBrandName.getText().toString());
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        if (oppick.equals("Bullet Lipstick")) {
            String newdate = month + "/ " + dayOfMonth + " / " + (year + 2);
            newexpiration.setText(newdate);
            newYear = (year +2);
        } else if (oppick.equals("Liquid Lipstick")) {

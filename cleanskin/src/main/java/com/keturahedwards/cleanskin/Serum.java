...
public class Serum extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    Animation zoom_in;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Serum.this, DashBoard.class));
            }
        });
    ...
    public void createCalenderPopIp() {
        ...
        icon.setImageResource((R.drawable.serum));
        ...
        save.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(CalendarContract.Events.TITLE, "Serum Update for " + newBrandName.getText().toString());

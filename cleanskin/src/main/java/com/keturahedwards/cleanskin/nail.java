...
public class nail extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(nail.this, DashBoard.class));
            }
        });
    }
    public void createCalenderPopIp() {
        ...
        icon.setImageResource((R.drawable.nail_polish01));

        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.nail, android.R.layout.simple_spinner_dropdown_item);

...
public class Mascara extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Mascara.this, DashBoard.class));
            }
        });
    ...
    public void createCalenderPopIp() {
        ...
        icon.setImageResource((R.drawable.mascara));
        ...
        save.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(CalendarContract.Events.TITLE, "Mascara update for " + newBrandName.getText().toString());
